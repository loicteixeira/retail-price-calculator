<script lang="ts">
	...
	const form = RetailForm.useState();
...
<svelte:head>
	...
	<meta
		name="description"
		content="This price calculator is a tool designed to help you decide how to price your retail products, taking into account a base price, bundles options and various fees."
	/>
</svelte:head>
		...
		<form class="mb-12 flex flex-col gap-6" novalidate>
			<div class="flex flex-row flex-wrap justify-between gap-6">
				...
				<div class="space-between flex flex-row flex-wrap gap-6">
					<RetailForm.SettingsFieldSet bind:currencyCode={form.state.currencyCode} />
					<RetailForm.ActionsFieldSet
